...
public class BodyPartQuiz {
	...
	String thirdImage = "src/Jennie.jpeg";
	...
	private void startQuiz() {
		...
		if (guess2.equals("Billie") || guess2.equals("Billie Eilish")) {
			...
			JOptionPane.showMessageDialog(null, "Incorrect. This is Billie.");
		}
		showNextImage();
		String guess3 = JOptionPane.showInputDialog("Who is this?");
		if (guess3.equals("Jennie") || guess3.equals("Jennie Kim")) {
			JOptionPane.showMessageDialog(null, "Correct");
			score ++;
		}
		else {
			JOptionPane.showMessageDialog(null, "Incorrect. This is Jennie.");
		}
